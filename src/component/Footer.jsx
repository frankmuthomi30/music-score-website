...
const FooterLink = ({ to, children }) => (
  <Link to={to} className="text-white hover:text-cyan-500 transition-colors duration-300">
    {children}
  </Link>
);
...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-r from-black to-gray-800 text-white py-12 mt-auto">
